...
LOGGED_EVENTS = frozenset({
    "run_started", "tool_execution_started", "auto_decision", "waiting_for_children",
    "message_injected", "compaction_completed", "run_completed", "run_failed",
    "run_cancelled", "run_limit_exceeded",
})
QUIET_KEYS = frozenset({
    "run_id", "session_id", "seq", "ts", "schema_version", "parent_id", "started_at", "context", "usage",
})
