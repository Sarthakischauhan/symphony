...
- Use spawn_agent for an isolated subtask (research, a parallel investigation, a bounded edit). Give it a short label and a complete prompt. The child cannot spawn further agents.
